    ...
    return (
        <div>
            ...
            <div className='qa-right'>
                ...
                <Seperator height={36} />
                <h1 style={{textAlign:'left',margin:'10px 0 10px 0',minWidth:'400px'}}>You are here</h1>
                <p style={{textAlign:'left',fontSize:14,color:'grey',minWidth:'400px',margin:'0 10px 0 20px',cursor:'pointer'}}>Home / Kerala / Full Home Cleaning in Kerala </p>
            </div>
        </div>
